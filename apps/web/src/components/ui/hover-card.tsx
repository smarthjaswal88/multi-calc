...
// Fast in, fast out: this opens over figures a reader is scanning, so it must not lag the pointer.
function HoverCard({
  openDelay = 150,
  closeDelay = 80,
  ...props
...
>(({ className, align = 'center', sideOffset = 6, ...props }, ref) => (
  <HoverCardPrimitive.Portal>
    <HoverCardPrimitive.Content
      ...
      className={cn(
        'z-50 rounded-md border border-border bg-popover p-3 text-sm text-popover-foreground shadow-md outline-none',
